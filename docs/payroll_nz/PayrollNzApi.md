...
------------- | ------------- | ------------- | -------------
 **xero_tenant_id** | **String**| Xero identifier for Tenant | 
 **pay_slip_id** | **String**| Identifier for the payslip | 
...
------------- | ------------- | ------------- | -------------
 **xero_tenant_id** | **String**| Xero identifier for Tenant | 
 **id** | **String**| Identifier for the statutory deduction | 
...
------------- | ------------- | ------------- | -------------
 **xero_tenant_id** | **String**| Xero identifier for Tenant | 
 **superannuation_id** | **String**| Identifier for the superannuation | 
