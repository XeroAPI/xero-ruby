...
module XeroRuby::PayrollNz
  ...
  class EarningsRate
    ...
    def valid?
      ...
      earnings_type_validator = EnumAttributeValidator.new('String', ["OvertimeEarnings", "Allowance", "RegularEarnings", "Commission", "Bonus", "Tips(Direct)", "Tips(Non-Direct)", "Backpay", "OtherEarnings", "LumpSum"])
    ...
    def earnings_type=(earnings_type)
      validator = EnumAttributeValidator.new('String', ["OvertimeEarnings", "Allowance", "RegularEarnings", "Commission", "Bonus", "Tips(Direct)", "Tips(Non-Direct)", "Backpay", "OtherEarnings", "LumpSum"])
