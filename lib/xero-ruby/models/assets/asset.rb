...
module XeroRuby::Assets
  class Asset
    ...
    def hash
      [asset_id, asset_name, asset_type_id, asset_number, purchase_date, purchase_price, disposal_price, asset_status, warranty_expiry_date, serial_number, book_depreciation_setting, book_depreciation_detail, can_rollback, accounting_book_value, is_delete_enabled_for_date].hash
    end
