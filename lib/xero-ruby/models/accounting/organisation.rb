...
module XeroRuby::Accounting
  ...
  class Organisation
    ...
    def valid?
      ...
      organisation_type_validator = EnumAttributeValidator.new('String', ["ACCOUNTING_PRACTICE", "COMPANY", "CHARITY", "CLUB_OR_SOCIETY", "INDIVIDUAL", "LOOK_THROUGH_COMPANY", "NOT_FOR_PROFIT", "PARTNERSHIP", "S_CORPORATION", "SELF_MANAGED_SUPERANNUATION_FUND", "SOLE_TRADER", "SUPERANNUATION_FUND", "TRUST", "SINGLEMEMBERLLC", "UNSPECIFIED"])
      ...
      organisation_entity_type_validator = EnumAttributeValidator.new('String', ["ACCOUNTING_PRACTICE", "COMPANY", "CHARITY", "CLUB_OR_SOCIETY", "INDIVIDUAL", "LOOK_THROUGH_COMPANY", "NOT_FOR_PROFIT", "PARTNERSHIP", "S_CORPORATION", "SELF_MANAGED_SUPERANNUATION_FUND", "SOLE_TRADER", "SUPERANNUATION_FUND", "TRUST", "SINGLEMEMBERLLC", "UNSPECIFIED"])
    ...
    def organisation_type=(organisation_type)
      validator = EnumAttributeValidator.new('String', ["ACCOUNTING_PRACTICE", "COMPANY", "CHARITY", "CLUB_OR_SOCIETY", "INDIVIDUAL", "LOOK_THROUGH_COMPANY", "NOT_FOR_PROFIT", "PARTNERSHIP", "S_CORPORATION", "SELF_MANAGED_SUPERANNUATION_FUND", "SOLE_TRADER", "SUPERANNUATION_FUND", "TRUST", "SINGLEMEMBERLLC", "UNSPECIFIED"])
      unless validator.valid?(organisation_type)
        fail ArgumentError, "invalid value \"#{organisation_type}\" for \"organisation_type\", must be one of #{validator.allowable_values}."
      end
    ...
    def organisation_entity_type=(organisation_entity_type)
      ...
      unless validator.valid?(organisation_entity_type)
        fail ArgumentError, "invalid value \"#{organisation_entity_type}\" for \"organisation_entity_type\", must be one of #{validator.allowable_values}."
      end
