...
module XeroRuby::PayrollUk
  ...
  class EarningsTemplate
    ...
    attr_accessor :pay_template_earning_id
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `XeroRuby::PayrollUk::EarningsTemplate` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `XeroRuby::PayrollUk::EarningsTemplate`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }

      if attributes.key?(:'pay_template_earning_id')
        self.pay_template_earning_id = attributes[:'pay_template_earning_id']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          pay_template_earning_id == o.pay_template_earning_id &&
    ...
    def hash
      [pay_template_earning_id, rate_per_unit, number_of_units, fixed_amount, earnings_rate_id, name].hash
    end
