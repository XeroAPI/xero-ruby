...
# Unit tests for XeroRuby::PayrollAu::LeaveAccrualLine
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'LeaveAccrualLine' do
  before do
    # run before each test
    @instance = XeroRuby::PayrollAu::LeaveAccrualLine.new
  end
  ...
  describe 'test an instance of LeaveAccrualLine' do
    it 'should create an instance of LeaveAccrualLine' do
      expect(@instance).to be_instance_of(XeroRuby::PayrollAu::LeaveAccrualLine)
    end
  end
  ...
  describe 'test attribute "auto_calculate"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
