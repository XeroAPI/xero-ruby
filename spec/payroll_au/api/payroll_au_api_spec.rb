...
# Unit tests for XeroRuby::PayrollAu::PayrollAuApi
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'PayrollAuApi' do
  before do
    # run before each test
    @api_instance = XeroRuby::PayrollAu::PayrollAuApi.new
  end
  ...
  describe 'test an instance of PayrollAuApi' do
    it 'should create an instance of PayrollAuApi' do
      expect(@api_instance).to be_instance_of(XeroRuby::PayrollAu::PayrollAuApi)
    end
  end
