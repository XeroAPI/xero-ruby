...
# Unit tests for XeroRuby::PayrollUk::EarningsRate
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'EarningsRate' do
  before do
    # run before each test
    @instance = XeroRuby::PayrollUk::EarningsRate.new
  end
  ...
  describe 'test an instance of EarningsRate' do
    it 'should create an instance of EarningsRate' do
      expect(@instance).to be_instance_of(XeroRuby::PayrollUk::EarningsRate)
    end
  end
  ...
  describe 'test attribute "earnings_type"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["Allowance", "Backpay", "Bonus", "Commission", "LumpSum", "OtherEarnings", "OvertimeEarnings", "RegularEarnings", "StatutoryAdoptionPay", "StatutoryMaternityPay", "StatutoryPaternityPay", "StatutorySharedParentalPay", "StatutorySickPay", "Tips(Direct)", "Tips(Non-Direct)"])
