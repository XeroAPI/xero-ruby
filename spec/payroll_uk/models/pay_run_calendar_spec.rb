...
# Unit tests for XeroRuby::PayrollUk::PayRunCalendar
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'PayRunCalendar' do
  before do
    # run before each test
    @instance = XeroRuby::PayrollUk::PayRunCalendar.new
  end
  ...
  describe 'test an instance of PayRunCalendar' do
    it 'should create an instance of PayRunCalendar' do
      expect(@instance).to be_instance_of(XeroRuby::PayrollUk::PayRunCalendar)
    end
  end
