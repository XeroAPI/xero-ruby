...
# Unit tests for XeroRuby::PayrollUk::SalaryAndWage
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'SalaryAndWage' do
  before do
    # run before each test
    @instance = XeroRuby::PayrollUk::SalaryAndWage.new
  end
  ...
  describe 'test an instance of SalaryAndWage' do
    it 'should create an instance of SalaryAndWage' do
      expect(@instance).to be_instance_of(XeroRuby::PayrollUk::SalaryAndWage)
    end
  end
  ...
  describe 'test attribute "status"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["Active", "Pending", "History"])
  ...
  describe 'test attribute "payment_type"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["Salary"])
      # validator.allowable_values.each do |value|
