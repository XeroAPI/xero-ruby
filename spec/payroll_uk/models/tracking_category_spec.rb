...
# Unit tests for XeroRuby::PayrollUk::TrackingCategory
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'TrackingCategory' do
  before do
    # run before each test
    @instance = XeroRuby::PayrollUk::TrackingCategory.new
  end
  ...
  describe 'test an instance of TrackingCategory' do
    it 'should create an instance of TrackingCategory' do
      expect(@instance).to be_instance_of(XeroRuby::PayrollUk::TrackingCategory)
    end
  end
