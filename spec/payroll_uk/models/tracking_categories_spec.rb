...
# Unit tests for XeroRuby::PayrollUk::TrackingCategories
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'TrackingCategories' do
  before do
    # run before each test
    @instance = XeroRuby::PayrollUk::TrackingCategories.new
  end
  ...
  describe 'test an instance of TrackingCategories' do
    it 'should create an instance of TrackingCategories' do
      expect(@instance).to be_instance_of(XeroRuby::PayrollUk::TrackingCategories)
    end
  end
