...
# Unit tests for XeroRuby::PayrollUk::TimesheetObject
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'TimesheetObject' do
  before do
    # run before each test
    @instance = XeroRuby::PayrollUk::TimesheetObject.new
  end
  ...
  describe 'test an instance of TimesheetObject' do
    it 'should create an instance of TimesheetObject' do
      expect(@instance).to be_instance_of(XeroRuby::PayrollUk::TimesheetObject)
    end
  end
