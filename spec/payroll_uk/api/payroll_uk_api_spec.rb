...
# Unit tests for XeroRuby::PayrollUk::PayrollUkApi
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'PayrollUkApi' do
  before do
    # run before each test
    @api_instance = XeroRuby::PayrollUk::PayrollUkApi.new
  end
  ...
  describe 'test an instance of PayrollUkApi' do
    it 'should create an instance of PayrollUkApi' do
      expect(@api_instance).to be_instance_of(XeroRuby::PayrollUk::PayrollUkApi)
    end
  end
