...
# Unit tests for XeroRuby::PayrollNz::EarningsOrders
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'EarningsOrders' do
  before do
    # run before each test
    @instance = XeroRuby::PayrollNz::EarningsOrders.new
  end
  ...
  describe 'test an instance of EarningsOrders' do
    it 'should create an instance of EarningsOrders' do
      expect(@instance).to be_instance_of(XeroRuby::PayrollNz::EarningsOrders)
    end
  end
