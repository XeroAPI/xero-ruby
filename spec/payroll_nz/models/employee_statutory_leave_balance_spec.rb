...
# Unit tests for XeroRuby::PayrollNz::EmployeeStatutoryLeaveBalance
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'EmployeeStatutoryLeaveBalance' do
  before do
    # run before each test
    @instance = XeroRuby::PayrollNz::EmployeeStatutoryLeaveBalance.new
  end
  ...
  describe 'test an instance of EmployeeStatutoryLeaveBalance' do
    it 'should create an instance of EmployeeStatutoryLeaveBalance' do
      expect(@instance).to be_instance_of(XeroRuby::PayrollNz::EmployeeStatutoryLeaveBalance)
    end
  end
