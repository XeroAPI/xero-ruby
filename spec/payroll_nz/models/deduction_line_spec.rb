...
# Unit tests for XeroRuby::PayrollNz::DeductionLine
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'DeductionLine' do
  before do
    # run before each test
    @instance = XeroRuby::PayrollNz::DeductionLine.new
  end
  ...
  describe 'test an instance of DeductionLine' do
    it 'should create an instance of DeductionLine' do
      expect(@instance).to be_instance_of(XeroRuby::PayrollNz::DeductionLine)
    end
  end
