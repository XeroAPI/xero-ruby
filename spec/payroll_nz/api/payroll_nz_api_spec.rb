...
# Unit tests for XeroRuby::PayrollNz::PayrollNzApi
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'PayrollNzApi' do
  before do
    # run before each test
    @api_instance = XeroRuby::PayrollNz::PayrollNzApi.new
  end
  ...
  describe 'test an instance of PayrollNzApi' do
    it 'should create an instance of PayrollNzApi' do
      expect(@api_instance).to be_instance_of(XeroRuby::PayrollNz::PayrollNzApi)
    end
  end
