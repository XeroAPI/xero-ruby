...
# Unit tests for XeroRuby::Accounting::BankTransactions
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'BankTransactions' do
  before do
    # run before each test
    @instance = XeroRuby::Accounting::BankTransactions.new
  end
  ...
  describe 'test an instance of BankTransactions' do
    it 'should create an instance of BankTransactions' do
      expect(@instance).to be_instance_of(XeroRuby::Accounting::BankTransactions)
    end
  end
