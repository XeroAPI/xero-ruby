...
# Unit tests for XeroRuby::Accounting::ExpenseClaim
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'ExpenseClaim' do
  before do
    # run before each test
    @instance = XeroRuby::Accounting::ExpenseClaim.new
  end
  ...
  describe 'test an instance of ExpenseClaim' do
    it 'should create an instance of ExpenseClaim' do
      expect(@instance).to be_instance_of(XeroRuby::Accounting::ExpenseClaim)
    end
  end
