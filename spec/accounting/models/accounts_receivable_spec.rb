...
# Unit tests for XeroRuby::Accounting::AccountsReceivable
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'AccountsReceivable' do
  before do
    # run before each test
    @instance = XeroRuby::Accounting::AccountsReceivable.new
  end
  ...
  describe 'test an instance of AccountsReceivable' do
    it 'should create an instance of AccountsReceivable' do
      expect(@instance).to be_instance_of(XeroRuby::Accounting::AccountsReceivable)
    end
  end
