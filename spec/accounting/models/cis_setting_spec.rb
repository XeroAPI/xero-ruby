...
# Unit tests for XeroRuby::Accounting::CISSetting
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'CISSetting' do
  before do
    # run before each test
    @instance = XeroRuby::Accounting::CISSetting.new
  end
  ...
  describe 'test an instance of CISSetting' do
    it 'should create an instance of CISSetting' do
      expect(@instance).to be_instance_of(XeroRuby::Accounting::CISSetting)
    end
  end
