...
# Unit tests for XeroRuby::Accounting::BankTransaction
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'BankTransaction' do
  before do
    # run before each test
    @instance = XeroRuby::Accounting::BankTransaction.new
  end
  ...
  describe 'test an instance of BankTransaction' do
    it 'should create an instance of BankTransaction' do
      expect(@instance).to be_instance_of(XeroRuby::Accounting::BankTransaction)
    end
  end
