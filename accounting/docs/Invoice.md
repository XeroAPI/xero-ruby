...
**is_discounted** | **Boolean** | boolean to indicate if an invoice has a discount | [optional] [readonly] 
**payments** | [**Array&lt;Payment&gt;**](Payment.md) | See Payments | [optional] [readonly] 
**prepayments** | [**Array&lt;Prepayment&gt;**](Prepayment.md) | See Prepayments | [optional] [readonly] 
**overpayments** | [**Array&lt;Overpayment&gt;**](Overpayment.md) | See Overpayments | [optional] [readonly] 
...
**fully_paid_on_date** | **Date** | The date the invoice was fully paid. Only returned on fully paid invoices | [optional] [readonly] 
...
**credit_notes** | [**Array&lt;CreditNote&gt;**](CreditNote.md) | Details of credit notes that have been applied to an invoice | [optional] [readonly] 
