...
module XeroRuby
  class AccountingApi
    ...
    def create_credit_note_attachment_by_file_name_with_http_info(xero_tenant_id, credit_note_id, file_name, include_online, body, opts = {})
      ...
      # resource path
      local_var_path = '/CreditNotes/{CreditNoteID}/Attachments/{FileName}'.sub('{' + 'CreditNoteID' + '}', CGI.escape(credit_note_id.to_s)).sub('{' + 'FileName' + '}', CGI.escape(file_name.to_s)).sub('{' + 'IncludeOnline' + '}', CGI.escape(include_online.to_s))
    ...
    def create_invoice_attachment_by_file_name_with_http_info(xero_tenant_id, invoice_id, file_name, include_online, body, opts = {})
      ...
      # resource path
      local_var_path = '/Invoices/{InvoiceID}/Attachments/{FileName}'.sub('{' + 'InvoiceID' + '}', CGI.escape(invoice_id.to_s)).sub('{' + 'FileName' + '}', CGI.escape(file_name.to_s)).sub('{' + 'IncludeOnline' + '}', CGI.escape(include_online.to_s))
    ...
    def create_quote_attachment_by_file_name_with_http_info(xero_tenant_id, quote_id, file_name, body, opts = {})
      ...
      # resource path
      local_var_path = '/Quotes/{QuoteID}/Attachments/{FileName}'.sub('{' + 'QuoteID' + '}', CGI.escape(quote_id.to_s)).sub('{' + 'FileName' + '}', CGI.escape(file_name.to_s))
    ...
    def create_quote_history_with_http_info(xero_tenant_id, quote_id, history_records, opts = {})
      ...
      # resource path
      local_var_path = '/Quotes/{QuoteID}/History'.sub('{' + 'QuoteID' + '}', CGI.escape(quote_id.to_s))
    ...
    def get_purchase_order_by_number_with_http_info(xero_tenant_id, purchase_order_number, opts = {})
      ...
      # resource path
      local_var_path = '/PurchaseOrders/{PurchaseOrderNumber}'.sub('{' + 'PurchaseOrderNumber' + '}', CGI.escape(purchase_order_number.to_s))
    ...
    def get_quote_with_http_info(xero_tenant_id, quote_id, opts = {})
      ...
      # resource path
      local_var_path = '/Quotes/{QuoteID}'.sub('{' + 'QuoteID' + '}', CGI.escape(quote_id.to_s))
    ...
    def get_quote_as_pdf_with_http_info(xero_tenant_id, quote_id, opts = {})
      ...
      # resource path
      local_var_path = '/Quotes/{QuotesID}/pdf'.sub('{' + 'QuoteID' + '}', CGI.escape(quote_id.to_s))
    ...
    def get_quote_attachment_by_id_with_http_info(xero_tenant_id, quote_id, attachment_id, content_type, opts = {})
      ...
      # resource path
      local_var_path = '/Quotes/{QuoteID}/Attachments/{AttachmentID}'.sub('{' + 'QuoteID' + '}', CGI.escape(quote_id.to_s)).sub('{' + 'AttachmentID' + '}', CGI.escape(attachment_id.to_s))
    ...
    def get_quote_attachments_with_http_info(xero_tenant_id, quote_id, opts = {})
      ...
      # resource path
      local_var_path = '/Quotes/{QuoteID}/Attachments'.sub('{' + 'QuoteID' + '}', CGI.escape(quote_id.to_s))
