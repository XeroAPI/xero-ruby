...
# Unit tests for Petstore::Organisation
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'Organisation' do
  before do
    # run before each test
    @instance = Petstore::Organisation.new
  end
  ...
  describe 'test an instance of Organisation' do
    it 'should create an instance of Organisation' do
      expect(@instance).to be_instance_of(Petstore::Organisation)
    end
  end
  ...
  describe 'test attribute "organisation_type"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["COMPANY", "CHARITY", "CLUBSOCIETY", "PARTNERSHIP", "PRACTICE", "PERSON", "SOLETRADER", "TRUST"])
      # validator.allowable_values.each do |value|
