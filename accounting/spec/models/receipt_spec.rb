...
# Unit tests for Petstore::Receipt
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'Receipt' do
  before do
    # run before each test
    @instance = Petstore::Receipt.new
  end
  ...
  describe 'test an instance of Receipt' do
    it 'should create an instance of Receipt' do
      expect(@instance).to be_instance_of(Petstore::Receipt)
    end
  end
  ...
  describe 'test attribute "status"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["DRAFT", "SUBMITTED", "AUTHORIZED", "DECLINED"])
