...
# Unit tests for Petstore::TaxRate
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'TaxRate' do
  before do
    # run before each test
    @instance = Petstore::TaxRate.new
  end
  ...
  describe 'test an instance of TaxRate' do
    it 'should create an instance of TaxRate' do
      expect(@instance).to be_instance_of(Petstore::TaxRate)
    end
  end
  ...
  describe 'test attribute "report_tax_type"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["OUTPUT", "INPUT", "EXEMPTOUTPUT", "INPUTTAXED", "BASEXCLUDED", "EXEMPTEXPENSES", "EXEMPTINPUT", "ECOUTPUT", "ECOUTPUTSERVICES", "ECINPUT", "ECACQUISITIONS", "CAPITALSALESOUTPUT", "CAPITALEXPENSESINPUT", "MOSSSALES", "NONE", "GSTONIMPORTS"])
      # validator.allowable_values.each do |value|
