...
# Unit tests for Petstore::Overpayment
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'Overpayment' do
  before do
    # run before each test
    @instance = Petstore::Overpayment.new
  end
  ...
  describe 'test an instance of Overpayment' do
    it 'should create an instance of Overpayment' do
      expect(@instance).to be_instance_of(Petstore::Overpayment)
    end
  end
  describe 'test attribute "type"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["RECEIVE-OVERPAYMENT", "SPEND-OVERPAYMENT"])
